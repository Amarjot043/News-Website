...
xhr.open('GET', 'https://newsapi.org/v2/top-headlines?country=in&apiKey=084aae8cc9c34b969f340082685718f7', true
);
...
xhr.onload = function () {
    ...
    >
        <div class="card-body">
            ${element.description}..........for more visit <br> <a href="${element.url}">Read More</a>
        </div>
    </div>
</div>`;
